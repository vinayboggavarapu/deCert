...
contract DeCert {
    ...
    function addUserData(address _userAddress, string memory _data) external {
        require(s_details[msg.sender].isIssuer, "DeCert__OnlyIssuerRequired");
        require(_userAddress == msg.sender, "DeCert__Invalid__User");
        string memory _email = s_details[_userAddress].email;
